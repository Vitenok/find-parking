...
// "http://localhost:8080/ws/emulator?wsdl"
public class ParkingOrderEmulatorWebServiceService extends Service {
	...
	static {
		...
		// url = new URL("http://localhost:8080/ws/emulator?wsdl");
		if (url == null) {
			java.util.logging.Logger.getLogger(ParkingOrderEmulatorWebServiceService.class.getName()).log(java.util.logging.Level.INFO, "Can not initialize the default wsdl from {0}", "classpath:ParkingOrderEmulatorWebServiceService.wsdl");
		}
	...
	/**
	 * 
	 * @return returns ParkingOrderEmulatorWebService
	 */
